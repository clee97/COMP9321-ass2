  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
      	...
      	<li><a href="graph2.jsp"><b> <i class="glyphicon glyphicon-chevron-right">  </i>Search for user 'clee'</b><span class="sr-only"></span></a></li>
      </ul>
...
<div class="col-xs-12" style="text-align: center;"><h2><u>Default data</u></h2></div>
...
<script type="text/javascript">
    ...
    var nodes = new vis.DataSet([
        {id: 0, label: 'userId: 0\nusername: systemadmin', group:'userGroup'},
        {id: 1, label: 'userId: 1\nusername: clee', group:'userGroup'},
        {id: 2, label: 'userId: 2\nusername: ttruong', group:'userGroup'},
        {id: 3, label: 'userId: 3\nusername: lmak', group:'userGroup'},
        {id: 4, label: 'postId: 0\nposter: clee', group:'postGroup'},
        {id: 5, label: 'postId: 1\nposter: clee', group:'postGroup'},
        {id: 6, label: 'postId: 2\nposter: ttruong', group:'postGroup'},
        {id: 7, label: 'postId: 3\nposter: lmak', group:'postGroup'},
        {id: 8, label: 'postId: 4\nposter: lmak', group:'postGroup'},        
    ]);
