  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
      	...
      	<li><a href="graph4.jsp"><b> <i class="glyphicon glyphicon-chevron-right">  </i>Search for friends of user 'clee'</b><span class="sr-only"></span></a></li>
      </ul>
...
<div class="col-xs-12" style="text-align: center;"><h2><u>Search for specific post with postId(0)</u></h2></div>
