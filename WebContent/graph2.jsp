  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
      	...
      	<li><a href="graph3.jsp"><b> <i class="glyphicon glyphicon-chevron-right">  </i>Search for specific post with postId(0)</b><span class="sr-only"></span></a></li>
      </ul>
...
<div class="col-xs-12" style="text-align: center;"><h2><u>Searching for user 'clee'</u></h2></div>
